...
describe("skill-eval-cell catalog", () => {
  ...
  test("required-read files are only the load-bearing ones", () => {
    ...
    expect(listed).toEqual(
      [
        ...
        "ce-code-review/all-scope-deadline-reaps-every-job:references/all-reviewers-external.md",
        "ce-code-review/all-scope-disclosure-before-start:references/all-reviewers-external.md",
        "ce-code-review/all-scope-failed-job-runs-twin:references/all-reviewers-external.md",
        "ce-code-review/all-scope-folded-provenance:references/all-reviewers-external.md",
        "ce-code-review/all-scope-mode-off-with-explicit-opt-in:references/all-reviewers-external.md",
        "ce-code-review/all-scope-mode-off-without-opt-in:references/cross-model-review.md",
        "ce-code-review/all-scope-own-family-only-falls-back:references/cross-model-review.md",
        "ce-code-review/all-scope-pr-remote-starts-nothing:references/cross-model-review.md",
        "ce-code-review/all-scope-prohibition-beats-key:references/cross-model-review.md",
        "ce-code-review/all-scope-prompt-requests-all:references/all-reviewers-external.md",
        "ce-code-review/all-scope-prompt-requests-default:references/cross-model-review.md",
        "ce-code-review/all-scope-quota-stops-external-phase:references/all-reviewers-external.md",
        "ce-code-review/all-scope-routes-eligible-personas:references/all-reviewers-external.md",
        ...
        "ce-doc-review/all-scope-failed-lens-coverage-row:references/all-reviewers-external.md",
        "ce-doc-review/all-scope-routes-eligible-lenses:references/all-reviewers-external.md",
  ...
  test("feature-only decision rows are explicitly post-only", () => {
    expect(SCENARIOS.filter((s) => s.post_only).map((s) => s.id).sort()).toEqual([
      ...
      "ce-code-review/all-scope-deadline-reaps-every-job",
      "ce-code-review/all-scope-disclosure-before-start",
      "ce-code-review/all-scope-failed-job-runs-twin",
      "ce-code-review/all-scope-folded-provenance",
      "ce-code-review/all-scope-mode-off-with-explicit-opt-in",
      "ce-code-review/all-scope-mode-off-without-opt-in",
      "ce-code-review/all-scope-own-family-only-falls-back",
      "ce-code-review/all-scope-pr-remote-starts-nothing",
      "ce-code-review/all-scope-prohibition-beats-key",
      "ce-code-review/all-scope-prompt-requests-all",
      "ce-code-review/all-scope-prompt-requests-default",
      "ce-code-review/all-scope-quota-stops-external-phase",
      "ce-code-review/all-scope-routes-eligible-personas",
      ...
      "ce-doc-review/all-scope-failed-lens-coverage-row",
      "ce-doc-review/all-scope-routes-eligible-lenses",
